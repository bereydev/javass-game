...
public final class PackedCardSet {
    ...
    public static long trumpAbove(int pkCard) {
        Preconditions.checkArgument(PackedCard.isValid(pkCard));
    ...
    public static boolean isEmpty(long pkCardSet) {
        Preconditions.checkArgument(isValid(pkCardSet));
    ...
    public static int get(long pkCardSet, int index) {
        Preconditions.checkArgument(isValid(pkCardSet) && size(pkCardSet) < index);
        for (int i = 0; i < index; i++) {
            pkCardSet = pkCardSet & ~Long.lowestOneBit(pkCardSet);
        }
        return PackedCard.pack(PackedCard.color((int)Math.floor(Long.numberOfTrailingZeros(pkCardSet)/16)),PackedCard.rank(Long.numberOfTrailingZeros(pkCardSet) % 16));
    }
    ...
    public static long add(long pkCardSet, int pkCard) {
        Preconditions.checkArgument(isValid(pkCardSet) && PackedCard.isValid(pkCard));
    ...
    public static long union(long pkCardSet1, long pkCardSet2) {
        Preconditions.checkArgument(isValid(pkCardSet1) && isValid(pkCardSet2));
    ...
    public static long difference(long pkCardSet1, long pkCardSet2) {
        Preconditions.checkArgument(isValid(pkCardSet1));
